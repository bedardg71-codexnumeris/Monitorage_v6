...
### 1. Pratiques prédéfinies prêtes à tester

Choisissez la pratique que vous avez décrite et testez l'application :
...
### 2. 🧙 Découvrez Primo, le Wizard de création de pratiques (8 étapes)
