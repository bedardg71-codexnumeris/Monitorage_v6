...
const DESCRIPTIONS_SEUILS = {
    ...
    directionRisque: {
        ...
        description: 'Variation minimale du risque (en points de pourcentage) pour afficher une flèche indiquant que le risque augmente (→) ou diminue (←). En dessous de ce seuil, une ligne horizontale (⎯) indique une stagnation.',
        unite: 'points (%)',
        min: 0.03,
        max: 0.15,
        pas: 0.01
